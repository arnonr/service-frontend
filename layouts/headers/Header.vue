      ...
      <div class="header__top-4 header__padding-4">
        <div class="container">
          <div class="row align-items-center">
            <!-- Logo SICC -->
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-5 col-5">
              <div class="logo">
                <NuxtLink to="/">
                  <img
                    src="~/assets/img/icon/logo-kmutnb-final.jpg"
              ...
              <div>
                <h3 class="d-none d-xl-block d-lg-block text-color-primary">
                  งานบริการวิชาการ
                </h3>
                <h6 class="d-none d-xl-block d-lg-block">
