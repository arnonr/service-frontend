<template>
        ...
        <div class="col-xxl-12">
          <div class="breadcrumb__content p-relative z-index-1">
            <div class="breadcrumb__list">
              ...
              <span>
                <NuxtLink href="/admin/service-category">
                  รายการประเภทการให้บริการวิชาการ
                </NuxtLink></span
              >
              <span class="dvdr"><i class="fa-solid fa-circle-small"></i></span>
  ...
  <section class="portfolio__area pt-40 pb-40">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <h4>แบบฟอร์มเพิ่มข้อมูลประเภท</h4>
        </div>
...
const onSubmit = async () => {
  ...
  let type_object = {
    ...
    method: "post",
    url: runtimeConfig.public.apiBase + "/service-category/",
  };
  ...
  await $fetch(type_object.url, {
    ...
    .then((res) => {
      if (res.msg == "success") {
        ...
        router.push({ path: "/admin/service-category/" });
      } else {
