        ...
        <div class="col-xxl-12">
          <div class="breadcrumb__content p-relative z-index-1">
            <div class="breadcrumb__list">
              ...
              <span> รายการประเภทการให้บริการวิชาการ </span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="mt-10 mb-30 pl-10 pt-15 pb-10 bg-grey">
        <h4>
          ...
          <span class="ml-10">รายการประเภท</span>
        </h4>
      </div>
      <div class="mb-30">
        <button
          ...
          @click="
            () => {
              $router.push({ path: '/admin/service-category/add' });
            }
          "
        >
              ...
              <tbody v-if="items.length != 0">
                <tr v-for="(it, idx) in items" :key="idx">
                  ...
                  <td class="text-center">
                    <NuxtLink
                      :to="{
                        name: 'admin-service-category-edit-id',
                        params: { id: it.id },
                      }"
...
const onDelete = async (id) => {
  await $fetch(`${runtimeConfig.public.apiBase}/service-category/${id}`, {
    method: "delete",
  })
    .then((res) => {
      if (res.msg == "success") {
